            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                <div class="flex justify-center">
                    <img src="{{ asset('images/site_images/about-us-k9-dogs-luggage-search.jpeg') }}"
                        alt="Army Dog Center trained K9 dogs searching luggage alongside their handler" width="600"
                        height="360" class="w-full max-w-md rounded-lg shadow-lg" loading="lazy">
                </div>
                <div>
