                ...
                <div class="relative">
                    ...
                    <button type="button" id="togglePassword" tabindex="-1"
                        ...
                        <svg id="eyeOffIcon" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 hidden" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M3 3l18 18M10.584 10.587a2 2 0 002.828 2.83M9.363 5.365A9.466 9.466 0 0112 5c4.477 0 8.268 2.943 9.542 7a10.02 10.02 0 01-4.132 5.411M6.223 6.223A9.996 9.996 0 002.458 12c1.274 4.057 5.065 7 9.542 7 1.522 0 2.968-.34 4.257-.949" />
                        </svg>
                    </button>
                </div>
